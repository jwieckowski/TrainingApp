...
describe('/api/v1/favorite', function () {
  let instance
  ...
  test('delete request with number in param should return status 400', async function () {
    const result = await instance.inject({
      method: 'DELETE',
      url: '/api/v1/favorite/param'
    })
